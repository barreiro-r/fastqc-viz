...
classic report: [FastQC](https://www.bioinformatics.babraham.ac.uk/projects/fastqc/good_sequence_short_fastqc.html) | ✨ `fastqcviz` report : [fastqcviz](https://html-preview.github.io/?url=https://github.com/barreiro-r/fastqc-viz/blob/man/figures/example.html)


![Screenshots of original FastQC and fastqcviz reports.](man/figures/before-after.png)
